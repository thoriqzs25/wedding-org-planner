    ...
    <div className="text-center py-10 text-amber-800/40">
      ...
      {actionLabel && onAction && (
        <button onClick={onAction}
          className="cursor-pointer inline-flex items-center gap-2 px-5 py-2.5 bg-orange text-white rounded-xl font-medium hover:bg-orange/90 transition-colors shadow-sm text-sm">
